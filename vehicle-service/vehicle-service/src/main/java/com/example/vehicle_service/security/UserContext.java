package com.example.vehicle_service.security;
...
/**
 * Extracts the user's email and role from HTTP headers
 * added by the API Gateway's JWT filter.
 */
@Component
@Slf4j
public class UserContext {
    ...
    private String getHeader(String headerName) {
        ...
        if (attributes == null) {
            log.warn("No request context available for header: {}", headerName);
            return null;
        }
